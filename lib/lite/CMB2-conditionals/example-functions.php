...
function yourprefix_register_conditionals_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		...
		'name'    => __( 'Test Multi Checkbox', 'psp_projects' ),

		'desc'    => __( 'field description (optional)', 'psp_projects' ),
		...
		'options' => array(
			...
			'check1' => __( 'Check One', 'psp_projects' ),

			'check2' => __( 'Check Two', 'psp_projects' ),

			'check3' => __( 'Check Three', 'psp_projects' ),
