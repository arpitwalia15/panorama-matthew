...
<div class="psp-dialog" style="display:none">
    <div id="psp-single-project-diaglog">
		...
		<table class="form-table psp-hide-table" id="psp-full-project-table">
			...
			<tr>
				<th><label for="psp-single-milestones"><?php echo esc_html_e('Milestones','psp_projects'); ?></label></th>
				<td>
			...
			<tr>
				<th><label for="psp-single-phases"><?php echo esc_html_e('Phases','psp_projects'); ?></label></th>
					<td>
						<select id="psp-single-phases">
							<option value="yes"><?php echo esc_html_e('Show Phases','psp_projects'); ?></option>
							<option value="no"><?php echo esc_html_e('No Phases','psp_projects'); ?></option>
						</select>
					</td>
			</tr>
		</table>
		...
		<p>
			<input class="button-primary" type="button" onclick="InsertPspProject();" value="<?php echo esc_html_e('Insert Project','psp_projects'); ?>"> 
