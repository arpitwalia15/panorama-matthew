...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'psp_projects' ),
			'defaultString' => esc_html__( 'Default', 'psp_projects' ),
			'pick'          => esc_html__( 'Select Color', 'psp_projects' ),
			'current'       => esc_html__( 'Current Color', 'psp_projects' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'psp_projects' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'psp_projects' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'psp_projects' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'psp_projects' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'psp_projects' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'psp_projects' ) ),
					'nextText'        => esc_html__( 'Next', 'psp_projects' ),
					'prevText'        => esc_html__( 'Prev', 'psp_projects' ),
					'currentText'     => esc_html__( 'Today', 'psp_projects' ),
					'closeText'       => esc_html__( 'Done', 'psp_projects' ),
					'clearText'       => esc_html__( 'Clear', 'psp_projects' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'psp_projects' ),
					'timeText'      => esc_html__( 'Time', 'psp_projects' ),
					'hourText'      => esc_html__( 'Hour', 'psp_projects' ),
					'minuteText'    => esc_html__( 'Minute', 'psp_projects' ),
					'secondText'    => esc_html__( 'Second', 'psp_projects' ),
					'currentText'   => esc_html__( 'Now', 'psp_projects' ),
					'closeText'     => esc_html__( 'Done', 'psp_projects' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'psp_projects' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'psp_projects' ),
				'upload_files' => esc_html__( 'Use these files', 'psp_projects' ),
				'remove_image' => esc_html__( 'Remove Image', 'psp_projects' ),
				'remove_file'  => esc_html__( 'Remove', 'psp_projects' ),
				'file'         => esc_html__( 'File:', 'psp_projects' ),
				'download'     => esc_html__( 'Download', 'psp_projects' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'psp_projects' ),
			),
		);
