...
abstract class WP_REST_Controller {
	...
	public function register_routes() {
		...
		_doing_it_wrong( 'WP_REST_Controller::register_routes', sprintf( esc_html__( "Method '%s' must be overridden.", 'psp_projects' ), __METHOD__ ), '4.7' );
	...
	public function get_items_permissions_check( $request ) {
      // translators: %s represents the field key that caused the error.
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be overridden in subclass.", 'psp_projects' ), __METHOD__ ), array(
	...
	public function get_collection_params() {
		...
		return array(
			...
			'page'                   => array(
				...
				'description'        => __( 'Current page of the collection.', 'psp_projects' ),
			...
			'per_page'               => array(
				...
				'description'        => __( 'Maximum number of items to be returned in result set.', 'psp_projects' ),
			...
			'search'                 => array(
				...
				'description'        => __( 'Limit results to those matching a string.', 'psp_projects' ),
	...
	public function get_context_param( $args = array() ) {
		...
		$param_details = array(
			...
			'description'        => __( 'Scope under which the request is made; determines fields present in response.', 'psp_projects' ),
