<?php
function psppan_lite_check_for_access( $post_id = null ) {
    ...
    $users = psppan_lite_parse_users( get_post_meta( $post_id, '_pano_users', true ) );
...
function psppan_lite_parse_users( $users = null ) {
...
function psppan_lite_comb_projects( $projects = null ) {
    ...
    while( $projects->have_posts() ) { $projects->the_post();
        ...
        if( psppan_lite_check_for_access( $post->ID ) ) {
            $combed_posts[] = $post;
        }
