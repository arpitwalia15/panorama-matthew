...
function eddpan_panorama_license_page() {
	...
	<div class="wrap">
        ...
        <h2 class="nav-tab-wrapper">
            ...
            <a href="edit.php?post_type=psp_projects&page=panorama-license&tab=psp_general_settings" class="nav-tab <?php if($active_tab == "psp_general_settings") { echo 'nav-tab-active'; } ?>"><?php esc_attr_e('General','psp_projects'); ?></a>

            <a href="edit.php?post_type=psp_projects&page=panorama-license&tab=psp_appearance" class="nav-tab <?php if($active_tab == "psp_appearance") { echo 'nav-tab-active'; } ?>"><?php esc_attr_e('Appearance','psp_projects'); ?></a>

			<a href="edit.php?post_type=psp_projects&page=panorama-license&tab=psp_other" class="nav-tab <?php if($active_tab == "psp_other") { echo 'nav-tab-active'; } ?>"><?php esc_attr_e('Pro Features','psp_projects'); ?></a>
		...
		<form method="post" action="options.php">
            ...
            <div id="psp_notifications" class="psp-settings-tab <?php if($active_tab == 'psp_notifications') { echo esc_attr("psp-settings-tab-active"); } ?>">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="checkbox" name="psp_include_logo" id="psp_include_logo" <?php if(get_option('psp_include_logo')) { echo esc_attr('checked'); } ?>>
    ...
    <textarea name="psp_default_message" id="psp_default_message" rows="10" cols="75"><?php echo esc_attr( get_option('psp_default_message') ); ?></textarea>
            ...
            <div id="psp_advanced" class="psp-settings-tab <?php if($active_tab == 'psp_advanced') { echo esc_attr("psp-settings-tab-active"); } ?>">
