...
#psp-projects ul.psp-milestones li.completed span {
    background: <?php echo esc_attr(get_option('psp_accent_color_1')); ?>;
    color: <?php echo esc_attr(get_option('psp_accent_color_1_txt')); ?>;
}
<?php endif; ?>
...
#psp-projects .color-teal .psp-task-list li em.status {
    background: <?php echo esc_attr(get_option('psp_accent_color_2')); ?> !important;
    color: <?php echo esc_attr(get_option('psp_accent_color_2_txt')); ?>;
}
<?php endif; ?>
...
#psp-projects .color-green .psp-task-list li em.status {
    background: <?php echo esc_attr(get_option('psp_accent_color_3')); ?> !important;
    color: <?php echo esc_attr(get_option('psp_accent_color_3_txt')); ?>;
}
<?php endif; ?>
...
#psp-projects .color-pink .psp-task-list li em.status {
    background: <?php echo esc_attr(get_option('psp_accent_color_4')); ?> !important;
    color: <?php echo esc_attr(get_option('psp_accent_color_4_txt')); ?>;
}
<?php endif; ?>
...
#psp-projects .color-maroon .psp-task-list li em.status {
    background: <?php echo esc_attr(get_option('psp_accent_color_5')); ?> !important;
    color: <?php echo esc_attr(get_option('psp_accent_color_5_txt')); ?>;
}
<?php endif; ?>
...
<?php if(get_option('psp_timeline_color')): ?>
	...
	#psp-projects .psp-date .cal .month {
		background: <?php echo esc_attr(get_option('psp_timeline_color')); ?>
	}

	#psp-projects .psp-time-indicator span {
		border-bottom-color: <?php echo esc_attr(get_option('psp_timeline_color')); ?>
	}
<?php endif; ?>

#psp-projects #psp-title #psp-main-nav #nav-menu ul li a {
    color: <?php echo esc_attr(get_option('psp_menu_text')); ?>;
}

#psp-projects #psp-title span {
    color: <?php echo esc_attr(get_option('psp_header_accent')); ?>;
}

body.psp-standalone-page,
#psp-projects,
#psp-projects.psp-standard-template {
    background-color: <?php echo esc_attr(get_option('psp_body_background')); ?>;
}
...
#psp-projects #psp-phases {
    border-color: <?php echo esc_attr(get_option('psp_body_background')); ?>;
}
...
#psp-projects .psp-time-indicator {
    color: <?php echo esc_attr(get_option('psp_body_text')); ?>;
}

#psp-projects #project-documents ul li a {
    color: <?php echo esc_attr(get_option('psp_body_link')); ?>;
}

#psp-projects #project-documents h3 {
    color: <?php echo esc_attr(get_option('psp_body_heading')); ?>;
}

#psp-projects #psp-discussion {
    background-color: <?php echo esc_attr(get_option('psp_footer_background')); ?>;
}

<?php echo wp_kses_post(get_option('psp_open_css')); ?>
